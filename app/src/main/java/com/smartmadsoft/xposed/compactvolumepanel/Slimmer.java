package com.smartmadsoft.xposed.compactvolumepanel;
...
public class Slimmer implements IXposedHookInitPackageResources {
    ...
    public void handleInitPackageResources(XC_InitPackageResources.InitPackageResourcesParam initPackageResourcesParam) throws Throwable {
        ...
        initPackageResourcesParam.res.hookLayout(PKG, "layout", "volume_panel_item", new XC_LayoutInflated() {
            @Override
        ...
        initPackageResourcesParam.res.hookLayout(PKG, "layout", "volume_panel", new XC_LayoutInflated() {
            @Override
        ...
        initPackageResourcesParam.res.hookLayout(PKG, "layout", "zen_mode_panel", new XC_LayoutInflated() {
            @Override
            public void handleLayoutInflated(LayoutInflatedParam liparam) throws Throwable
            {
                final int zenModePanelBgContainer = liparam.res.getIdentifier("zen_mode_panel_bg_container", "id", PKG);
                final FrameLayout layoutZenModePanelBgContainer = (FrameLayout)liparam.view.findViewById(zenModePanelBgContainer);
